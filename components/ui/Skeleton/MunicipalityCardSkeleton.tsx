...
const MunicipalityCardSkeleton: React.FC = () => {
  return (
    <div className="relative bg-background rounded-xl sm:rounded-2xl overflow-hidden w-full h-[90px] sm:h-[100px] md:h-[110px] lg:h-[120px] xl:h-[130px] shadow-lg animate-pulse">
